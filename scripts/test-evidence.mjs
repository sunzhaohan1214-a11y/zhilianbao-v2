...
export const UAT_PATHS = [
  ...
  path("AI_STRUCTURED_QUERY", "荷宝结构化查询、私密拒答与安全降级", [evidence("unit", "tests/unit/ai-evaluation.test.ts"), evidence("security", "tests/security/route-matrix.test.ts"), evidence("e2e", "tests/e2e/weak-network.spec.ts")]),
