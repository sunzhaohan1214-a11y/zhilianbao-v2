...
export function PolicyGovernanceActions({ id, publicationStatus, effectStatus, publishedPolicies, activeRelations }: { id: string; publicationStatus: string; effectStatus: string; publishedPolicies: Option[]; activeRelations: Array<{ id: string; label: string }> }) {
  const router = useRouter(); const [message, setMessage] = useState(""); const [busy, setBusy] = useState(false);
