...
export function fakeSystemProvidersEnabled(environment: RuntimeEnv = process.env): boolean { return environment.ENABLE_FAKE_SYSTEM_PROVIDERS === "true" && (environment.NODE_ENV === "test" || environment.APP_ENV === "test"); }
