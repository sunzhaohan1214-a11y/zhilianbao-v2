...
export type DemandMutationContext = Pick<AuthRequestContext, "requestId" | "ip" | "deviceName">;

export async function writeDemandAudit(
...
export async function writeDemandTransition(
  tx: Prisma.TransactionClient,
  input: {
    actor?: PermissionActor;
    entityType: "DEMAND_LEAD" | "DEMAND" | "DEMAND_OUTCOME_PLAN" | "DEMAND_OUTCOME_ROUND";
