...
export const DEMAND_ERROR_CODES = [
  ...
  "OUTCOME_NOT_FOUND",
  "OUTCOME_PLAN_ALREADY_EXISTS",
  "OUTCOME_PLAN_REQUIRED",
  "OUTCOME_NOT_TRACKED",
  "OUTCOME_NOT_DUE",
  "OUTCOME_ACTIVE_ROUND_EXISTS",
  "OUTCOME_VERSION_CONFLICT",
  "OUTCOME_STATE_CONFLICT",
  "OUTCOME_FORBIDDEN",
  "OUTCOME_EMPTY",
  "OUTCOME_ATTACHMENT_INVALID",
  "OUTCOME_IDEMPOTENCY_CONFLICT",
  "OUTCOME_VERIFICATION_REQUIRED",
  "OUTCOME_BATCH_INVALID",
] as const;
...
const DEMAND_STATUS_BY_CODE: Record<DemandErrorCode, number> = {
  ...
  OUTCOME_PLAN_ALREADY_EXISTS: 409,
  OUTCOME_PLAN_REQUIRED: 422,
  OUTCOME_NOT_TRACKED: 422,
  OUTCOME_NOT_DUE: 422,
  OUTCOME_ACTIVE_ROUND_EXISTS: 409,
  OUTCOME_VERSION_CONFLICT: 409,
  OUTCOME_STATE_CONFLICT: 409,
  OUTCOME_FORBIDDEN: 403,
  OUTCOME_EMPTY: 422,
  OUTCOME_ATTACHMENT_INVALID: 422,
  OUTCOME_IDEMPOTENCY_CONFLICT: 409,
  OUTCOME_VERIFICATION_REQUIRED: 422,
  OUTCOME_BATCH_INVALID: 422,
};
