...
beforeAll(async () => {
  ...
  await createDemand({ businessNo: `M3004${randomUUID().replaceAll("-", "").slice(0, 10)}`, title: "历史久未更新需求", publishedAt: new Date("2026-05-01T09:00:00+08:00"), ownerAt: new Date("2026-05-01T09:00:00+08:00"), lastProgressAt: new Date("2026-05-20T09:00:00+08:00") });
